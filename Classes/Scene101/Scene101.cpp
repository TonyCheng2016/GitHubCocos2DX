...
bool Scene101::init()
{
	...
	auto label1 = Label::createWithBMFont("fonts/van.fnt", "Scene 101");
	...
	auto label2 = Label::createWithBMFont("fonts/bx1.fnt", str1);
	auto label3 = Label::createWithBMFont("fonts/bx1.fnt", str2);
